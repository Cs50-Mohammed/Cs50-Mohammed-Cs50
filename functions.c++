...
// الـ Function هي مجموعة من الأوامر التي تؤدي مهمة محددة. تساعدك على:
//  تقسيم البرنامج إلى أجزاء صغيرة

// إعادة استخدام الكود

// تنظيم البرنامج وجعله أكثر وضوحاً
